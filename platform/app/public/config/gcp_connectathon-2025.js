...
const gcpBaseURL = 'https://dicomwebproxy.app/dicomWeb';
  ...
  dataSources: [
    {
      ...
      configuration: {
        name: 'GCP',
        // wadoUriRoot: `${gcpBaseURL}/dicomWeb`,
        // qidoRoot: `${gcpBaseURL}/dicomWeb`,
        // wadoRoot: `${gcpBaseURL}/dicomWeb`,
        wadoUriRoot: `${gcpBaseURL}`,
        qidoRoot: `${gcpBaseURL}`,
        wadoRoot: `${gcpBaseURL}`,
